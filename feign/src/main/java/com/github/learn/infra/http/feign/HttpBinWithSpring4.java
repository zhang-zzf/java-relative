...
public interface HttpBinWithSpring4 {
    ...
    /**
     * @param map  添加 QueryMap 参数，序列化到 url 的请求参数中 POST
     *             https://httpbin.org/post?map=name=%E5%BC%A0%E5%8D%A0%E5%B3%B0&map=id=1 HTTP/1.1 map
     *             中的多个参数并未按照key=value 的形式被映射到 url 参数中 建议多个参数，写多个 @RequestParam。
     * @param body 请求 body
     */
