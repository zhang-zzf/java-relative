...
public class SpringCacheConfigWithSwitchControl {
    ...
    @Bean(CACHE_RESOLVER)
    public SwitchAbilityCacheResolver switchAbilityCacheResolver(@Qualifier(CACHE_MANAGE) CacheManager cacheManager) {
    ...
    public static class SwitchAbilityCacheResolver extends AbstractCacheResolver {
        ...
        @Override protected Collection<String> getCacheNames(CacheOperationInvocationContext<?> context) {
