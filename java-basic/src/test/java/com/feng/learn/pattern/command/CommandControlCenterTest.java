...
public class CommandControlCenterTest {
    ...
    public void testACommandManyActions() {
        ...
        AllLightOffCommand allLightOffCommand = new AllLightOffCommand(light, ceilingLight, outdoorLight);
    ...
    public void testComposeCommand() {
        ...
        ComposeCommand allLightOn = new ComposeCommand(new Command[]{outDoorLightOn, livingRoomLightOn});
        ComposeCommand allLightOff = new ComposeCommand(new Command[]{outDoorLightOff, livingRoomLightOff});
