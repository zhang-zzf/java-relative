...
class MaximumLengthOfSubarrayWithPositiveProductTest {
    ...
    void givenNormal_when_thenSuccess() {
        ...
        then(solution.getMaxLen(new int[]{5, -20, -20, -39, -5, 0, 0, 0, 36, -32, 0, -7, -10, -7, 21, 20, -12, -34, 26, 2})).isEqualTo(6);
    }
        ...
        public int getMaxLen(int[] nums) {
            ...
            for (int i = 0; i < nums.length; i++) {
                ...
                if (n > 0) {
                    ...
                    int newPositive = negativeCnt == 0 ? 0 : negativeCnt + 1;
                    positiveCnt = newPositive;
