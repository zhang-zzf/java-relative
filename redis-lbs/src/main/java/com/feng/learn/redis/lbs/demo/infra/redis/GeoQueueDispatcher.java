...
public class GeoQueueDispatcher {
    ...
    private Set<String> geoHashToSearch(double lat, double lon, long radius) {
        ...
        BoundingBox bbox = new BoundingBox(
            VincentyGeodesy.moveInDirection(VincentyGeodesy.moveInDirection(center, 180, radius), 270, radius),
            VincentyGeodesy.moveInDirection(VincentyGeodesy.moveInDirection(center, 0, radius), 90, radius));
        TwoGeoHashBoundingBox twoGeoHashBoundingBox = TwoGeoHashBoundingBox.withCharacterPrecision(bbox, precision);
