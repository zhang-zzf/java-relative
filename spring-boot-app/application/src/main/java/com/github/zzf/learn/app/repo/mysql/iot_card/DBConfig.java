package com.github.zzf.learn.app.repo.mysql.iot_card;

import com.baomidou.mybatisplus.autoconfigure.SpringBootVFS;
import com.baomidou.mybatisplus.core.MybatisConfiguration;
import com.baomidou.mybatisplus.extension.spring.MybatisSqlSessionFactoryBean;
import com.github.zzf.learn.app.repo.mysql.iot_card.mapper.DaoPackage;
...
public class DBConfig {
    ...
    public MybatisSqlSessionFactoryBean mybatisSqlSessionFactoryBean(
        ...
        // config.setLogPrefix("dao.%s.".formatted(DB_ID));
    ...
    public Flyway flyway(@Qualifier(DATASOURCE_BEAN_ID) DataSource dataSource) {
        Flyway flyway = Flyway.configure()
            ...
            // watch out: should use '/' instead of '.' in the location
