...
@Configuration
public class ThreadPoolForStation {

    public static final String ASYNC_THREAD = "spring-@Async-station";
    ...
    public ThreadPoolTaskExecutor taskExecutor() {
        ...
        taskExecutor.setCorePoolSize(cpuNum);// 核心线程
        taskExecutor.setMaxPoolSize(cpuNum);// 最大线程
        taskExecutor.setQueueCapacity(cpuNum);// BQ队列大小
