...
public class SwitchAop {
    ...
    public Object functionGray(ProceedingJoinPoint pjp, DegradeSwitch degradeSwitch) throws Throwable {
        String configKey = pjp.getSignature().getDeclaringType().getSimpleName() + "#" + pjp.getSignature().getName();
        ...
        if (degrade) {
            ...
            Method degradeToMethod = pjp.getTarget().getClass().getDeclaredMethod(degradeSwitch.degradeTo(), parameterTypes);
            // 设置访问权限
