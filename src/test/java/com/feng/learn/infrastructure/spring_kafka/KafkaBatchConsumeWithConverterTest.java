...
import static com.feng.learn.infrastructure.spring_kafka.KafkaBatchConsumeWithConverterTest.Config.*;
...
public class KafkaBatchConsumeWithConverterTest {
    ...
    public static class Config {
        ...
        public ConsumerFactory consumerFactory() {
            ...
            consumerConfigs.put(INTERCEPTOR_CLASSES_CONFIG, Arrays.asList(TraceConsumerInterceptor.class));
